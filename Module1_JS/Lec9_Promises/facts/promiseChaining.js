...
f1KaPromise.then(function(data){
    ...
    return f2KaPromise;     //return islye kia kuki then function hme f2Kapromise p lgana h..return ni krte to vo pure function p lgta
})
.then(function(data){        //then ka bhi promise ho skta h                    
    console.log(data+"");
