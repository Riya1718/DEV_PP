...
pencilInputSize.addEventListener("change" , function(){
    let updatedPencilSize = pencilInputSize.value;
    ctx.lineWidth = updatedPencilSize;
    currentPencilSize = updatedPencilSize;
})

eraserInputSize.addEventListener("change" , function(){
    let updatedEraserSize = eraserInputSize.value;
